...
@section('link')
<link href="{{ asset('eshop/theme') }}/assets/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css">
...
<link href="{{ asset('eshop/theme') }}/assets/plugins/rateit/src/rateit.css" rel="stylesheet" type="text/css">
@endsection
@section('content')
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="{{ asset('images') }}/{{$id->photo}}" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="{{ asset('images') }}/{{$id->photo}}">
                  </div>
                  <div class="product-other-images">
                    <a href="{{ asset('images') }}/{{$id->photo}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('images') }}/{{$id->photo}}"></a>
                    <a href="{{ asset('images') }}/{{$id->photo}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('images') }}/{{$id->photo}}"></a>
                    <a href="{{ asset('images') }}/{{$id->photo}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('images') }}/{{$id->photo}}"></a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="description">
                    <p>Shopnow menjual berbagai produk barang berkualitas mulai dari sneakers, clothing, jeans dan barang kekinian lainnya.
                        Jika ingin lebih detail lagi, Anda juga bisa memilih barang dari tiap kategori produk dihalaman utama.
                  ...
                  <div class="product-page-cart">
                    <div class="product-quantity">
                        <input id="product-quantity" type="text" value="1" name="qty" class="form-control input-sm">
                    </div>
